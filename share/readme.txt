项目介绍：
    ...
    <modules>
        ...
        <module>consumerser</module>  消费者  说明：使用feign调用helloser中的接口  集成hystrix异常熔断
        <module>oauthser</module>       权限服务
        <module>turbineser</module>     hystrix熔断集群监控   使用：访问http://localhost:9523/hystrix    在页面输入框中输入需要监控的微服务地址  例：http://192.168.10.214:8764/hystrix.stream
