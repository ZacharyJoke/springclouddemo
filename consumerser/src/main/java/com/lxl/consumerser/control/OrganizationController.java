...
public class OrganizationController {
    ...
    @ApiOperation(value="getOrganization", notes="获取机构信息接口")
    @ApiImplicitParams({
    ...
    @ApiOperation(value="listPageByPagehelper", notes="获取机构列表接口")
    ...
    @ApiOperation(value="findListByPagingAndSorting", notes="获取机构列表接口")
